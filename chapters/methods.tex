...
Modanovo-TMT was applied on an unpublished clinical dataset provided by the Kusterlab [refernce tbd]. This cohort comprises approximately 300 Glioma patient samples, representing a diverse spectrum of tumor grades and molecular subtypes like Astrocytoma, Oligodendroglioma, and Glioblastoma. 
...
Since deep learning models primarily operate on mass-to-charge ratios ($m/z$) and the resulting mass differences, they essentially identify mass shifts rather than unique chemical identities \cite{Muth2012}.
...
\begin{itemize}
    ...
    \item \textbf{Literature Comparison:} Cross-referencing mapped positions with previous studies and databases like PhosphoSitePlus \cite{Hornbeck2015}.
\end{itemize}
