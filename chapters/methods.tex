...
Note:  It is important to note that this state is chemically paradoxical, as both the TMT reagent and the acetylation/ubiquination/methylation process compete for the same primary amine ($\epsilon$-amino group) of the lysine side chain.The appearance of this specific mass delta in the training data is highly unusual and occurred only in very rare instances. Given that a single nitrogen atom cannot host both modifications simultaneously, these occurrences require further investigation. )
