...
Additionally future refinement of the finetuning dataset could benefit from including unmodified TMT data to provide a more balanced representation of the peptide space. Finally, extending the model architecture with specialized "heads" for downstream tasks—such as PTM localization scoring or direct PTM classification—would further enhance the interpretability and confidence of the sequencing results \cite{ProPeptMT2025} or could be one task for itself.
