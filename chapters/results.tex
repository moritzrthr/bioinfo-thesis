...
\begin{figure}[H] 
    ...
    \caption{Distribution and frequency of identified peptide modifications along the PYGL sequence. The y-axis (log-scaled) displays spectral counts. Yellow labels indicate phosphorylation sites. Color coding: Blue (Modanovo-TMT + MaxQuant consensus), Red (MaxQuant only), Green (Modanovo-TMT only).}
