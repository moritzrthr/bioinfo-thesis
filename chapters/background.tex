...
As a result, autoregressive decoding with beam search significantly improves identification accuracy, particularly in ambiguous or noisy spectra \cite{Yilmaz2023}.
