...
DeepNovo pioneered the use of CNNs for feature extraction \cite{Tran2017}. However, the self-attention-based decoding strategy was popularized by Casanovo \cite{Yilmaz2022}. 
...
As a result, autoregressive decoding with beam search improves identification accuracy, particularly in ambiguous or noisy spectra \cite{Yilmaz2022}.
